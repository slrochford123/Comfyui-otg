...
function candidateOutputRoots() {
  ...
  return uniqueList([
    ...
    // Your active ComfyUI output folder from current testing.
    "E:\\Renders\\ComfyUI",
...
async function streamLocalImage(filePath: string, filename: string) {
  ...
  return new Response(webStream, {
    ...
    headers: {
      ...
      "X-OTG-Comfy-Image-Source": "local-fullres-file-v36y",
...
async function proxyComfyView(args: {
  ...
  return new Response(body, {
    ...
    headers: {
      ...
      "Cache-Control": "no-store, max-age=0",
      "X-OTG-Comfy-Image-Source": "comfy-view-fullres-proxy-v36y",
      "X-OTG-Comfy-View-Url": url.toString(),
    },
  });
}

// OTG_COMFY_IMAGE_OUTPUT_ROOT_V36Y

...
import { failWorkerLifecycleCommand } from "@/lib/workers/workerLifecycleStore";
...
export async function POST(req: NextRequest) {
  ...
  const command = failWorkerLifecycleCommand(commandId, agentId, body.value.error || "Worker lifecycle command failed.", body.value.result);

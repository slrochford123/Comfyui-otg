...
- [ ] Live closure of WorkerManager status and Applio HTTP 400 awaits transactional activation of the follow-up TEST release. Do not mark the cluster complete before authenticated status and worker logs pass live.

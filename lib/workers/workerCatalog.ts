...
export const WORKER_CATALOG = [
  ...
  },
  {
    ...
    userVisible: false,
    allowedActions: ["status", "start", "stop", "restart"],
    description: "Windows Whisper transcription service at port 9001. It remains dry-run only until WorkerManager ownership is verified.",
    lane: "audio",
    userStatusKind: "service",
  },
  {
    ...
    userVisible: false,
    allowedActions: ["status", "start", "stop", "restart"],
    description: "Windows pyannote speaker diarization service at port 9010. It remains dry-run only until WorkerManager ownership is verified.",
    lane: "audio",
    userStatusKind: "service",
  },
  {
  ...
  },
  {
    ...
    userVisible: false,
    allowedActions: ["status", "start", "stop", "restart"],
    description: "Windows ACE-Step 1.5 music generation service at port 7860. It remains dry-run only until WorkerManager ownership is verified.",
    lane: "audio",
    gpu: "windows-3090",
    userStatusKind: "service",
  },

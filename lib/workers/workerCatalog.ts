...
export const WORKER_CATALOG = [
  ...
  },
  {
    ...
    enabled: true,
    dryRunOnly: false,
    resources: ["gpu:windows-3090", "comfy:windows-3090", "service:ltx-video"],
    dependencies: [],
    idleTimeoutSeconds: 1200,
    dangerousStop: true,
    userVisible: false,
    allowedActions: ["status", "start", "stop", "restart"],
    description: "Windows RTX 3090 ComfyUI lane reserved for LTX/video workloads. WorkerManager ownership is enabled after clean stopped-state wrapper validation. Qwen image jobs must not route here.",
    lane: "video",
    gpu: "windows-3090",
    userStatusKind: "lane",
  },
